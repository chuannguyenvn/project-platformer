namespace Assets
{
    ...
    export const FileLookUp = {
        ...
        [Assets.Key.Sprite.CIRCLE]: './assets/images/circle.png',
        [Assets.Key.Sprite.SQUARE]: './assets/images/square.png',
        [Assets.Key.Sprite.GRADIENT_TOP_TO_BOTTOM]: './assets/images/gradient-top-to-bottom.png',
        [Assets.Key.Sprite.KENNEY_DEFAULT_TILESET]: './assets/images/kenney-pixel-platformer.png',
    }
}
